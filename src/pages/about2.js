	...
	return (
		<>
			...
			<center>
				...
				<div style={{ maxWidth: '1000px' }}>
					<p style={{ textAlign: 'justify' }}>
						...
						time, I didn’t really know what I really enjoyed about photography,
						and so I would have told you then that I was a photographer. It
						wasn’t until later in life after pursuing several years of different
						types of photography that I realized that photographing people was
						something that I really enjoyed. I really love capturing raw
						moments, and the different emotions that come photographing people.
						My goal is to one day take this love that I have for photographing
						people and transform it into a full-time career.
					</p>
				</div>
			</center>
			<br></br>
			...
			<div>
				<center>
					<div>
                        <img src={TK_Sitting} alt='TK' width='700' height='600' />
                    </div>
					<br></br>
					<div style={{ maxWidth: '1000px' }}>
