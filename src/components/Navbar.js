...
export default function Navbar(props) {
	...
	const navigation = [
		{ name: 'Me', href: '/about', current: location.pathname === '/about' },
		{
			name: 'Them',
			href: '/modelgallery',
			current: location.pathname === '/modelgallery',
		},
		{
			name: "Let's Create",
			href: '/bookings',
		...
		currentUser && {
			...
			current: location.pathname === '/send-anywhere',
		},
	].filter(Boolean);
											...
											<div>
												<Menu.Button className='relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800'>
													...
													<img
														...
														src={props.userProfilePictureUrl}
														alt=''
													/>
												</Menu.Button>
											</div>
